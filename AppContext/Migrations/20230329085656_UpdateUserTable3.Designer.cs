...
namespace SportMonitorAPI.AppContext.Migrations
{
    ...
    [Migration("20230329085656_UpdateUserTable3")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "84952520-b2d9-4dbb-9a4b-da9fbe2abcc9",
                            ConcurrencyStamp = "252238e4-8bf6-4194-8bc4-92157d501cb6",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "b92662d6-8382-47c9-854a-48577a4f4efd",
                            ConcurrencyStamp = "7ba6bfc1-0900-4b55-80b6-917be005dfb9",
                            Name = "Player",
                            NormalizedName = "PLAYER"
                        },
                        new
                        {
                            Id = "88d95473-1a51-4c91-899b-41fafe42e87a",
                            ConcurrencyStamp = "f8080d14-051a-4bbb-93a6-e9c0ccfb1a05",
                            Name = "Member",
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.Game", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 29, 11, 56, 56, 617, DateTimeKind.Local).AddTicks(7525));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.GamePerformance", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 29, 11, 56, 56, 618, DateTimeKind.Local).AddTicks(149));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.Measurement", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 29, 11, 56, 56, 618, DateTimeKind.Local).AddTicks(739));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.MeasurementTaken", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 29, 11, 56, 56, 618, DateTimeKind.Local).AddTicks(2563));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.PhysichalTest", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 29, 11, 56, 56, 618, DateTimeKind.Local).AddTicks(4106));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.Player", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 29, 11, 56, 56, 618, DateTimeKind.Local).AddTicks(3455));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.TestTaken", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 29, 11, 56, 56, 618, DateTimeKind.Local).AddTicks(5871));
