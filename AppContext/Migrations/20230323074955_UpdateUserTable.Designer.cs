...
namespace SportMonitorAPI.AppContext.Migrations
{
    ...
    [Migration("20230323074955_UpdateUserTable")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "191d787d-815c-4a14-b86e-6ee7aed3f060",
                            ConcurrencyStamp = "31f1892c-901d-4794-bf15-81c94e7b3360",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "39fd440b-0e5f-4d56-8eb3-74e58e07231a",
                            ConcurrencyStamp = "3fc6a318-1aa6-4f4f-a3bf-180bc06bc91a",
                            Name = "Player",
                            NormalizedName = "PLAYER"
                        },
                        new
                        {
                            Id = "7cb55d75-9a71-4b7e-a1b2-ee63ad7d596d",
                            ConcurrencyStamp = "3913a8bd-ab53-406e-a47d-c25f0420dedf",
                            Name = "Member",
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.Game", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 23, 9, 49, 54, 995, DateTimeKind.Local).AddTicks(5061));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.GamePerformance", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 23, 9, 49, 54, 995, DateTimeKind.Local).AddTicks(8391));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.Measurement", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 23, 9, 49, 54, 995, DateTimeKind.Local).AddTicks(9163));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.MeasurementTaken", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 23, 9, 49, 54, 996, DateTimeKind.Local).AddTicks(1396));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.PhysichalTest", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 23, 9, 49, 54, 996, DateTimeKind.Local).AddTicks(3173));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.Player", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 23, 9, 49, 54, 996, DateTimeKind.Local).AddTicks(2381));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.TestTaken", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 23, 9, 49, 54, 996, DateTimeKind.Local).AddTicks(5505));
