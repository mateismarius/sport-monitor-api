...
namespace SportMonitorAPI.AppContext.Migrations
{
    ...
    [Migration("20230314134837_IdentityAdded")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "86a4e1bb-e92e-4952-8227-fd18fabeb4c2",
                            ConcurrencyStamp = "939355c2-7a4f-4e2a-946b-0295b6c7e088",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "57cf894c-1705-4335-9a45-23d3806d2fed",
                            ConcurrencyStamp = "fdf3c08b-b8f2-4014-9311-59659c1faeb9",
                            Name = "Player",
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.Game", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 14, 15, 48, 37, 690, DateTimeKind.Local).AddTicks(4782));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.GamePerformance", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 14, 15, 48, 37, 690, DateTimeKind.Local).AddTicks(7403));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.Measurement", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 14, 15, 48, 37, 690, DateTimeKind.Local).AddTicks(7948));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.MeasurementTaken", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 14, 15, 48, 37, 690, DateTimeKind.Local).AddTicks(9675));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.PhysichalTest", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 14, 15, 48, 37, 691, DateTimeKind.Local).AddTicks(1248));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.Player", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 14, 15, 48, 37, 691, DateTimeKind.Local).AddTicks(566));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.TestTaken", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 14, 15, 48, 37, 691, DateTimeKind.Local).AddTicks(2946));
