...
namespace SportMonitorAPI.AppContext.Migrations
{
    ...
    [Migration("20230220105354_Initial-Create")]
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.Game", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 2, 20, 12, 53, 54, 431, DateTimeKind.Local).AddTicks(5479));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.GamePerformance", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 2, 20, 12, 53, 54, 431, DateTimeKind.Local).AddTicks(7462));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.Measurement", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 2, 20, 12, 53, 54, 431, DateTimeKind.Local).AddTicks(8087));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.MeasurementTaken", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 2, 20, 12, 53, 54, 432, DateTimeKind.Local).AddTicks(26));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.PhysichalTest", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 2, 20, 12, 53, 54, 432, DateTimeKind.Local).AddTicks(1731));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.Player", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 2, 20, 12, 53, 54, 432, DateTimeKind.Local).AddTicks(1056));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.TestTaken", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 2, 20, 12, 53, 54, 432, DateTimeKind.Local).AddTicks(3650));
