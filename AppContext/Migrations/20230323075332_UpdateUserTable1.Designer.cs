...
namespace SportMonitorAPI.AppContext.Migrations
{
    ...
    [Migration("20230323075332_UpdateUserTable1")]
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "b2502082-f8cf-4c7a-ad2b-5a729456d48d",
                            ConcurrencyStamp = "0d6228d3-9c0b-42cf-a3dd-b252ff1de6e2",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "a13f71e9-4181-49ff-912f-62d7f4b648fd",
                            ConcurrencyStamp = "0a5b1515-f411-4ae6-a0ed-418fd1c7d4cc",
                            Name = "Player",
                            NormalizedName = "PLAYER"
                        },
                        new
                        {
                            Id = "671c673e-44b6-4fd1-8ac3-04b503e41624",
                            ConcurrencyStamp = "f673575f-3dd3-43f7-a3ce-edae3dbec4ac",
                            Name = "Member",
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.Game", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 23, 9, 53, 31, 766, DateTimeKind.Local).AddTicks(7871));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.GamePerformance", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 23, 9, 53, 31, 767, DateTimeKind.Local).AddTicks(1364));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.Measurement", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 23, 9, 53, 31, 767, DateTimeKind.Local).AddTicks(2112));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.MeasurementTaken", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 23, 9, 53, 31, 767, DateTimeKind.Local).AddTicks(4153));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.PhysichalTest", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 23, 9, 53, 31, 767, DateTimeKind.Local).AddTicks(6034));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.Player", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 23, 9, 53, 31, 767, DateTimeKind.Local).AddTicks(5133));
            ...
            modelBuilder.Entity("SportMonitorAPI.Entities.TestTaken", b =>
                {
                    ...
                    b.Property<DateTime>("LastModified")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 3, 23, 9, 53, 31, 767, DateTimeKind.Local).AddTicks(8039));
